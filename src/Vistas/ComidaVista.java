...
public class ComidaVista extends javax.swing.JInternalFrame {
    ...
    private void jBGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardarActionPerformed
        ...
        if(comida == null){
//            comida = new Comida(nombre, , calorias, detalle, estado);
    ...
    public void cargarTabla(){
        ...
        for (Comida ing : comidas) {
                    modelo.addRow(new Object[]{ing.getNombre(),ing.getCaloriasPorcion(),ing.getEstado(),ing.getTipoComida(),ing.getDetalle()});
                }
    }
